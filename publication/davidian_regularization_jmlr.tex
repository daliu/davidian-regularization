...
% JMLR-specific packages (jmlr2e.sty file is corrupted, using standard formatting)
% \usepackage{jmlr2e}
...
% Note: Running title and keywords would normally use JMLR commands
% \ShortHeadings{Stability Bonus Davidian Regularization}{Liu}
% \Keywords{class imbalance, regularization, cross-validation, model selection, machine learning}
...
\noindent \textbf{Keywords:} class imbalance, regularization, cross-validation, model selection, machine learning
